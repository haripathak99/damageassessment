...
import Image from "../../RadixComponents/Image";
...
export default function FileUpload({
  ...
  return (
    <div className="flex flex-col gap-2">
      ...
      <div className="flex flex-col gap-2 scrollbar naxatw-max-h-52 naxatw-overflow-auto ">
        {/* @ts-ignore */}
        {uploadedFiles.map(({ file, id, previewURL }) => (
          <div
            key={id}
            className="flex naxatw-items-center naxatw-justify-between naxatw-rounded-lg naxatw-border naxatw-px-4 naxatw-py-2"
          >
            <div className="flex gap-4 naxatw-items-center">
